...
('Risoto de Camarão', 'Risoto de camarão com toque de limão siciliano and alho-poró.', 36.00, 'Prato Principal'),
...
(id_produto, ingredientes, fornecedor)
VALUES
...
INSERT INTO pedidos
(id_cliente, id_funcionario, id_produto, quantidade, data_pedido, status)
VALUES
